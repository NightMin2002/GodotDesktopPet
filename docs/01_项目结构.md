...
| `fall.gd` | 掉落 | 自由落体，撞击瞬间判定物理撞击爆发冲击波，速度低于阈值持续 0.3 秒回到 Idle |
| `jump.gd` | 弹跳 | 获得巨大冲量乱弹跳跃，赋予极其极客的全息拖影，能量落地归零回到 Idle |
...
stateDiagram-v2
    ...
    Idle --> Walk : 35% 几率经过 0.3-1.5s 后
    Idle --> Jump : 65% 几率发生高能弹射
    Idle --> Drag : 鼠标左键按住宠物
    Idle --> Fall : 突然失去地面
