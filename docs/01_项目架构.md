...
| `main.gd` | 脚本 | **启动调度器**。负责透明窗口初始化、屏幕边界墙创建、宠物实例化、五个子管理器编排 (`ghost_wall_manager` / `hit_region_manager` / `clone_manager` / `farewell_manager` / `game_manager`)、提醒系统/碎碎念/待办清单挂载、系统托盘、任务栏守护 |
