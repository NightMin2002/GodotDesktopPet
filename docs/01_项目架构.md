...
| `walk.gd` | **步态风格驱动移动**：蹦跳为主 → 纯冲量跳跃；滚动为主 → 100% 短距滚动 (120~300px，扭矩 15000 + 推力 8.0，高阻尼 linear=2.0/angular=0.8)；混合平衡 → 50% 蹦跳/50% 短距滚动。所有垂直冲量和扭矩均乘以 `gravity_sign` 适配反重力。含 0.8s 卡死检测 |
